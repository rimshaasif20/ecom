    ...
    <>
      ...
      <div className='container ml-4 mr-4 '>
        <Stack gap={3}>
          ...
          <div className='row'>
            <div className='col'>
              <Card className='element' style={{ height: '25 rem', width: '18rem', backgroundColor: "palegreen" }}>
                <Card.Body>
